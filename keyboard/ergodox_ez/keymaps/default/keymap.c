 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  | Del  |           |LMouse|   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | CTRL   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  | K/Gui|   L  |   ;  |   '"   |
 * |--------+------+------+------+------+------| Tab  |           | LFn  |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  cut | paste| copy | Alt  | LGui |                                       | RGui | App  |   [  |   ]  | LWin  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Left |Right |       |  Up  | Esc  |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | Down |        |      |
 *                                 |Space |  BS  |------|       |------| Space  |Enter |
 *                                 |      |      | End  |       |CmdAlt|        |      |
 *                                 `--------------------'       `----------------------'
 */
[OSX] = KEYMAP(  // layer 0 : default
        ...
        // right hand
             ...
             MO(FN),      KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_RSFT,
                                  KC_RGUI,KC_BTN2,KC_LBRC,KC_RBRC,    TO(WINDOWS,1),
             KC_UP,        KC_ESC,
             KC_DOWN,
             LGUI(KC_LALT),KC_SPC, KC_ENT
    ),
 ...
 * |--------+------+------+------+------+------|Layer |           | LFn  |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |  Edit|           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  cut | paste| copy | LAlt |F13/Win|                                      |  F14 |  App |   [  |   ]  | LMac |
 *   `-----------------------------------'                                      `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Left |Right |       | Home | End  |
 *                                 ,------|------|------|       |------+--------+------.
...
[WINDOWS] = KEYMAP(
        ...
        KC_TAB,     KC_Q,       KC_W,       KC_E,    KC_R,    KC_T,    KC_DELT,
        KC_LCTL,    KC_A,       KC_S,       KC_D,    KC_F,    KC_G,
        KC_LSFT,    KC_Z,       KC_X,       KC_C,    KC_V,    KC_B,    TO(EDIT,1),
        LCTL(KC_X), LCTL(KC_V), LCTL(KC_C), KC_LALT, GUI_T(KC_F13),
                                                              KC_LEFT, KC_RGHT,
                                                                       KC_PGUP,
        ...
        TO(MOUSE,1), KC_Y,  KC_U,   KC_I,    KC_O,    KC_P,    KC_BSLS,
                     KC_H,  KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        MO(FN),      KC_N,  KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                            KC_F14, KC_APP,  KC_LBRC, KC_RBRC, TO(OSX,1),
        KC_HOME, KC_END,
        KC_UP,
...
[FN] = KEYMAP(
       ...
       KC_TRNS,   KC_UP,    KC_7,  KC_8,    KC_9,     KC_ASTR,  KC_MINS,
                KC_DOWN,    KC_4,  KC_5,    KC_6,     KC_SLSH,  KC_PLUS,
       KC_TRNS, KC_AMPR,    KC_1,  KC_2,    KC_3,     KC_UP,    KC_ENT,
...
[EDIT] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  TO(WINDOWS,1),
       KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,
                                                       LCTL(KC_Z), LCTL(KC_Y),
                                                                   KC_TRNS,
                                             KC_TRNS,  KC_TRNS,    KC_TRNS,
       // right hand
       KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_LPRN,  KC_RPRN,  KC_BSPC,
       KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_LCBR,  KC_RCBR,  KC_BSLASH,
                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_LBRC,  KC_RBRC,  KC_QUOTE,
       KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_HOME,  KC_UP,    KC_END,
                          KC_TRNS,  KC_DOT,   KC_LEFT,  KC_DOWN,  KC_RGHT,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
    ),
